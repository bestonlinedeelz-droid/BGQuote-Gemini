        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              ...
              <li><button onClick={() => handleNavClick('/shopping')} className="hover:text-amber-500 transition-colors">Shopping</button></li>
              <li><button onClick={() => handleNavClick('/gift-ideas')} className="hover:text-amber-500 transition-colors">Gift Ideas</button></li>
